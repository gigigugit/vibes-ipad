...
2. Open `index.html` on the iPad.
3. Save the primary bookmarklet from the installer page.
4. If the hosted script is blocked on the EMR page, retry once with the inline fallback bookmarklet.
